...
router = (nav)=>{
    authorsRouter.get('/', (req,res)=>{
        ...
        response.title = 'Library App | Authors';
    ...
    authorsRouter.get('/add-author', (req,res)=>{
        ...
        response.title = 'Library App | Add New Author';
        if(req.session.user){
            response.nav = nav.user;
            response.profileName = req.session.user.fname + ' ' + req.session.user.sname;
            response.author = {},
    ...
    authorsRouter.get('/edit/:id', (req,res)=>{
        ...
        let response = {};
        response.title = 'Library App | Edit Author';
        if(req.session.user){
            response.nav = nav.user;
            response.profileName = req.session.user.fname + ' ' + req.session.user.sname;
    ...
    authorsRouter.post('/delete/',(req,res)=>{
        ...
        if(req.session.user){
            ...
            response.title = 'Library App | Delete Author';
            response.nav = nav.guest;
            response.profileName = '';
            res.render('accessDenied',response);
        }
